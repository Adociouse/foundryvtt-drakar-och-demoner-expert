...
| Rollformulärets standardstorlek höjd 680×800 → 900×1000 | **Done (2026-08-02)** | Johan: kändes för litet i praktiken, särskilt med förmågeradernas nya `<textarea>`. `resizable:true` sedan tidigare — det här är bara ett bekvämare default, ingen spärr. |
