...
59. **Automatiska raständers särskilda förmågor (t.ex. Skogsalvs "+5 CL Utmärkt balanssinne") är bara prosa, inte en `formaga`-post.** Johans fråga #3 den här sessionen. Deltar i ingen av de två modifierarpipelinerna (se `docs/dev/ARCHITECTURE.md`) — gäller inte bara Skogsalv utan varje ras med en `automaticAbilities`-textbeskrivning. Kräver antingen en riktig `formaga`-item per ras eller en dedikerad "raständer"-pipeline.
