...
> Skapad 2026-08-05, svar på Projektets fråga om recovery-mekanik för HP/PSY från föremål/besvärjelse/scen/värld. Följer samma Setup/Situation/Förväntat-mönster som `STRID_FLERHAND_ANVANDNINGSFALL.md` — facit för obyggd logik, inte en checklista mot körande kod.
>
...
> - **Grupp C nedan (UC-R16–R20, tillagd efter Projektets uppföljningsfråga) testar återhämtning specifikt i en stridsmiljö** — hittade en verklig, obyggd lucka (UC-R20).
...
## Grupp C — Stridsmiljö (2026-08-05: testa återhämtning i strid)

Samma Setup/Situation/Förväntat-mönster som ovan, men här specificerat strikt som **Aktör(er) / Miljö / Förväntat resultat** per Projektets uttryckliga krav — ett tydligare facit att köra live mot, inte bara läsa.
