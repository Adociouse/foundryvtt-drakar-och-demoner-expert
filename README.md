...
| Kompendier: 13 raser, 36 yrken, 339 vapen/utrustning, 222 besvärjelser, 214 monster | Klar (fortsatt luckor i bildtäckning och vapensortiment, samt i bestiary-täckningen mot källböckerna — se nedan) |
...
| `monster` | 214 varelser för NPC/monster-actortypen (hela Monsterboken 1 OCH 2, plus hela Monsterboxen II — inklusive stridsstatblock för de folkslag som också finns som spelbara raser) |
