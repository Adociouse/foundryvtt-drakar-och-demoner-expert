...
| Kompendier: 13 raser, 36 yrken, 339 vapen/utrustning, 222 besvärjelser, 22 monster | Klar (fortsatt luckor i bildtäckning och vapensortiment, samt i bestiary-täckningen mot källböckerna — se nedan) |
...
| `monster` | 22 varelser för NPC/monster-actortypen |
...
- **Bestiaryn täcker 22 av cirka 273 katalogförda varelser** över fyra källböcker (Monsterboken 1/2, Monsterboxen II/IV) — en full revision av alla fyra böckerna finns dokumenterad, resten byggs i omgångar.
