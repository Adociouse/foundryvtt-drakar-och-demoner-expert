...
| Kompendier: 13 raser, 36 yrken, 339 vapen/utrustning, 222 besvärjelser, 224 monster | Klar (fortsatt luckor i bildtäckning och vapensortiment, samt i bestiary-täckningen mot källböckerna — se nedan) |
...
| `monster` | 224 varelser för NPC/monster-actortypen (hela Monsterboken 1 OCH 2, plus hela Monsterboxen II — inklusive stridsstatblock för de folkslag som också finns som spelbara raser) |
...
- **Bestiaryn täcker 224 varelser** ur Monsterboken 1, Monsterboken 2, Monsterboxen II och Svartfolk-supplementets bestiariekapitel — alla fyra KOMPLETTA. ⚠ Täckningsgraden mot det samlade källmaterialet är dock **inte** fastställd: utöver Monsterboxen IV (56 poster, inga byggda) finns ytterligare tre böcker med varelsestatblock som ännu inte reviderats — *Monster och Man i Ereb Altor*, *Drakar* och *Svartfolk*-supplementet (skilt från Monsterboxen II:s Svartfolk-kapitel, som är byggt).
