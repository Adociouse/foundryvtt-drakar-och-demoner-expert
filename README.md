...
| Kompendier: 13 raser, 36 yrken, 339 vapen/utrustning, 305 besvärjelser, 241 monster | Klar (fortsatt luckor i bildtäckning och vapensortiment, samt i bestiary-täckningen mot källböckerna och besvärjelsekatalogens fullständighet — se nedan) |
...
| `besvarjelser` | 305 besvärjelser (263 besvärjelser + 42 minibesvärjelser) — Formelbokens katalogkomplettering pågår, ~10 av 13 magiskolor kvarstår |
...
- **De flesta besvärjelser saknar egen bildikon** — 297 av 305 visar sin magiskolas symbol i stället för unik konst.
- **Besvärjelsekatalogen är inte fullständig mot Formelboken.** Allmänna besvärjelser, Animism och Elementarmagi är kompletta (transkriberade skola för skola, se `docs/DESIGN_DECISIONS.md` §2); ~10 av 13 skolor (Harmonism, Illusionism, Mentalism, Nekromanti, Röstmagi, Spiritism, Stavmagi, Symbolism, Häxkonster, Demonologi) har fortfarande luckor mot boken.
