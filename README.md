...
| Kompendier: 13 raser, 36 yrken, 339 vapen/utrustning, 350 besvärjelser, 241 monster | Klar (fortsatt luckor i bildtäckning och vapensortiment, samt i bestiary-täckningen mot källböckerna och besvärjelsekatalogens fullständighet — se nedan) |
...
| `besvarjelser` | 350 besvärjelser (305 besvärjelser + 45 minibesvärjelser, minibesvärjelserna samlade i en egen "Minimagi"-mapp) — Formelbokens katalogkomplettering pågår, ~7 av 13 magiskolor kvarstår |
...
- **De flesta besvärjelser saknar egen bildikon** — 342 av 350 visar sin magiskolas symbol i stället för unik konst.
- **Besvärjelsekatalogen är inte fullständig mot Formelboken.** Allmänna besvärjelser, Animism, Elementarmagi, Harmonism, Häxkonster och Illusionism är kompletta (transkriberade skola för skola, se `docs/DESIGN_DECISIONS.md` §2); ~7 av 13 skolor (Mentalism, Nekromanti, Röstmagi, Spiritism, Stavmagi, Symbolism, Demonologi) har fortfarande luckor mot boken.
