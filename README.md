...
| Magisystem (kastning, PSY-resurs, minimagi, magiskolor) | Klar, med några medvetna förenklingar (se kodkommentarer). Minibesvärjelser används med en knapp på rollpersonsarket (1 PSY, ingen CL-kontroll; Shift-klick lägger till berättartext) och på NPC-arket (SL, med berättartext i chatten) — NPC-magiker kan även kasta vanliga besvärjelser via kast-dialogen |
