...
- **Bestiaryn täcker 205 varelser** ur Monsterboken 1, Monsterboken 2 och Monsterboxen II, som alla tre är KOMPLETTA. ⚠ Täckningsgraden mot det samlade källmaterialet är dock **inte** fastställd: utöver Monsterboxen IV (56 poster, inga byggda) finns ytterligare tre böcker med varelsestatblock som ännu inte reviderats — *Monster och Man i Ereb Altor*, *Drakar* och *Svartfolk*-supplementet (skilt från Monsterboxen II:s Svartfolk-kapitel, som är byggt).
- **Spelbara raser finns inte som stridbara NPC:er.** `raser`-kompendiet innehåller rollpersonsbyggstenar (Item-typen `ras`), inte aktörer — så en SL kan inte placera ut t.ex. ett högalvsgarde som motståndare utan att handbygga varje NPC. Källböckerna trycker färdiga stridsstatblock för dem; de är ännu inte byggda.
