...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 305 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, and spell catalogue completeness all still have gaps — see below) |
...
| `besvarjelser` | 305 spells (263 spells + 42 mini-spells) — Formelboken catalogue completion in progress, ~10 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 297 of 305 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, and Elementarmagi are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~10 of 13 schools (Harmonism, Illusionism, Mentalism, Nekromanti, Röstmagi, Spiritism, Stavmagi, Symbolism, Häxkonster, Demonologi) still have gaps against the book.
