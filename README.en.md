...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 350 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, and spell catalogue completeness all still have gaps — see below) |
...
| `besvarjelser` | 350 spells (305 spells + 45 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~7 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 342 of 350 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, and Illusionism are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~7 of 13 schools (Mentalism, Nekromanti, Röstmagi, Spiritism, Stavmagi, Symbolism, Demonologi) still have gaps against the book.
