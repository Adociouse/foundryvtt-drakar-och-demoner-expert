...
- **Heroic points** (a post-creation ability-spending mechanic) accumulate correctly but still lack their 18-row random table and a spending UI.
- **The build-point pool doesn't yet differ across the four tiers** (all 125) despite a sourced 125/150/175 table — pending a rules decision, see `docs/DESIGN_DECISIONS.md`.
