...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 222 spells, 100 monsters | Done (art coverage, weapon roster, and bestiary coverage against the source books all still have gaps — see below) |
...
| `monster` | 100 creatures for the NPC/monster actor type (all of Monsterboken 1 plus Monsterboxen II's Svartfolk chapter) |
...
- **The bestiary covers 100 of roughly 273 catalogued creatures** across four source books (Monsterboken 1/2, Monsterboxen II/IV) — a full audit of all four books exists, the rest is being built in batches.
