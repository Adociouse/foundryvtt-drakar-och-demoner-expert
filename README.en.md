...
| Magic system (casting, PSY resource, cantrips, magic schools) | Done, with a few deliberate simplifications (see code comments). Mini-spells are used with a button on the character sheet (1 PSY, no CL check; Shift-click adds story text) and on the NPC sheet (GM, with story text posted to chat) — NPC mages can also cast ordinary spells through the cast dialog |
