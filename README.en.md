...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 222 spells, 22 monsters | Done (art coverage, weapon roster, and bestiary coverage against the source books all still have gaps — see below) |
...
| `monster` | 22 creatures for the NPC/monster actor type |
...
- **The bestiary covers 22 of roughly 273 catalogued creatures** across four source books (Monsterboken 1/2, Monsterboxen II/IV) — a full audit of all four books exists, the rest is being built in batches.
