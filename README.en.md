...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 442 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 442 spells (401 spells + 41 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, only Demonologi (~9 spells) remains |
...
- **Most spells lack their own icon** — 434 of 442 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** 12 of 13 schools are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2) — only **Demonologi** (~9 spells, sourced to roughly p.12-16 via the book's own index but not yet read directly) remains.
- **~148 of 442 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass) — being upgraded school by school in the same pass as catalogue completion. General spells, Mentalism, Nekromanti, Röstmagi, Spiritism, Stavmagi, and Symbolism are fully done; Animism, Elementarmagi, Harmonism, Häxkonster, and Illusionism remain (complete on the spell list, not on description quality).
