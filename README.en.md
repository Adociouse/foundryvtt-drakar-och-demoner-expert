...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 409 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 409 spells (368 spells + 41 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~4 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 401 of 409 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, Illusionism, Mentalism, Nekromanti, and Röstmagi are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~4 of 13 schools (Spiritism, Stavmagi, Symbolism, Demonologi) still have gaps against the book.
- **~169 of 409 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass). Being upgraded school by school in the same pass as catalogue completion — Mentalism, Nekromanti, and Röstmagi are fully done, other schools remain.
