...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 405 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 405 spells (364 spells + 41 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~5 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 397 of 405 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, Illusionism, Mentalism, and Nekromanti are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~5 of 13 schools (Röstmagi, Spiritism, Stavmagi, Symbolism, Demonologi) still have gaps against the book.
- **~179 of 405 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass). Being upgraded school by school in the same pass as catalogue completion — Mentalism and Nekromanti are fully done, other schools remain.
