...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 222 spells, 224 monsters | Done (art coverage, weapon roster, and bestiary coverage against the source books all still have gaps — see below) |
...
| `monster` | 224 creatures for the NPC/monster actor type (all of Monsterboken 1 AND 2, plus all of Monsterboxen II — including combat statblocks for the peoples that also exist as playable races) |
