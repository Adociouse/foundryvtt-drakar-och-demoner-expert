...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 414 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 414 spells (373 spells + 41 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~3 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 406 of 414 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, Illusionism, Mentalism, Nekromanti, Röstmagi, and Spiritism are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~3 of 13 schools (Stavmagi, Symbolism, Demonologi) still have gaps against the book.
- **~156 of 414 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass). Being upgraded school by school in the same pass as catalogue completion — Mentalism, Nekromanti, Röstmagi, and Spiritism are fully done, other schools remain.
