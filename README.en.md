...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 419 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 419 spells (378 spells + 41 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~2 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 411 of 419 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, Illusionism, Mentalism, Nekromanti, Röstmagi, Spiritism, and Stavmagi are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~2 of 13 schools (Symbolism, Demonologi) still have gaps against the book.
- **~143 of 419 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass). Being upgraded school by school in the same pass as catalogue completion — Mentalism, Nekromanti, Röstmagi, Spiritism, and Stavmagi are fully done, other schools remain.
