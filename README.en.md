...
| Compendiums: 13 races, 36 professions, 339 weapons/equipment, 377 spells, 241 monsters | Done (art coverage, weapon roster, bestiary coverage against the source books, spell catalogue completeness, and description text quality all still have gaps — see below) |
...
| `besvarjelser` | 377 spells (332 spells + 45 mini-spells, mini-spells grouped in their own "Minimagi" folder) — Formelboken catalogue completion in progress, ~6 of 13 magic schools still incomplete |
...
- **Most spells lack their own icon** — 369 of 377 show their magic school's symbol instead of unique art.
- **The spell catalogue is not yet complete against Formelboken.** General spells, Animism, Elementarmagi, Harmonism, Häxkonster, Illusionism, and Mentalism are complete (transcribed school by school, see `docs/DESIGN_DECISIONS.md` §2); ~6 of 13 schools (Nekromanti, Röstmagi, Spiritism, Stavmagi, Symbolism, Demonologi) still have gaps against the book.
- **~178 of 377 spells only have a compressed one-line summary** instead of the book's actual description text (left over from the first 2026-07-27 porting pass). Being upgraded school by school in the same pass as catalogue completion — Mentalism is fully done, other schools remain.
